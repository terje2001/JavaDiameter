 ...
 * seconds.
 */
public final class AVP_Time extends AVP_Unsigned32 {
  private static final int seconds_between_1900_and_1970 = ((70 * 365) + 17) * 86400;

  public AVP_Time(final AVP a) throws InvalidAVPLengthException {
    super(a);
  }

  public AVP_Time(final int code, final Date value) {
    this(code, 0, value);
  }

  public AVP_Time(final int code, final int vendor_id, final Date value) {
    super(code, vendor_id, (int) (value.getTime() / 1000 + seconds_between_1900_and_1970));
  }

  public AVP_Time(final int code, final int seconds_since_1970) {
    this(code, 0, seconds_since_1970);
  }

  public AVP_Time(final int code, final int vendor_id, final int seconds_since_1970) {
