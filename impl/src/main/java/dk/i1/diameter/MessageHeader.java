...
public final class MessageHeader {
   ...
   */
  public MessageHeader(final MessageHeader mh) {
    version = mh.version;
  ...
  int encode(final byte b[], final int offset, final int message_length) {
  ...
  void decode(final byte b[], final int offset) {
   ...
   */
  public void prepareResponse(final MessageHeader request) {
   ...
   * @since 0.9.3
   */
  public void prepareAnswer(final MessageHeader request) {
