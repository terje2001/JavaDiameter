...
public final class Peer {
   ...
   */
  @Deprecated
  public Peer(final InetAddress address, final TransportProtocol transport_protocol) {
   ...
   */
  @Deprecated
  public Peer(final InetAddress address, final int port) {
   ...
   */
  @Deprecated
  public Peer(final InetAddress address, final int port, final TransportProtocol transport_protocol) {
   ...
   */
  public Peer(final String host) throws EmptyHostNameException {
    this(host, 3868);
  }
   ...
   * @param port The port of the peer.
   */
  public Peer(final String host, final int port) throws EmptyHostNameException {
   ...
   * @since 0.9.5
   */
  public Peer(final String host, final int port, final TransportProtocol transport_protocol)
  ...
  public static Peer fromURIString(String s) throws UnsupportedURIException {
    ...
    final Peer p = new Peer(uri);
    if (extra_stuff != null) {
      final StringTokenizer st1 = new StringTokenizer(extra_stuff, ";");
      while (st1.hasMoreTokens()) {
        final String part = st1.nextToken();
        final StringTokenizer st2 = new StringTokenizer(part, "=");
        if (!st2.hasMoreTokens()) {
          continue;
        }
        final String element_name = st2.nextToken();
        ...
        final String element_value = st2.nextToken();
