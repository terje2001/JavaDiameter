...
public final class NodeSettings {
  ...
  private final int firmware_revision;
  ...
  public static class PortRange {
    ...
    public PortRange(final int min, final int max) throws InvalidSettingException {
   ...
   */
  public NodeSettings(final String host_id, final String realm,
      final int vendor_id,
      final Capability capabilities,
      final int port,
      final String product_name, final int firmware_revision)
    ...
    if (vendor_id == 0) {
      throw new InvalidSettingException(
          "vendor_id must not be non-zero. (It must be your IANA-assigned \"SMI Network Management Private Enterprise Code\". See http://www.iana.org/assignments/enterprise-numbers)");
    }
   ...
   * @since 0.9.3
   */
  public void setWatchdogInterval(final long interval) throws InvalidSettingException {
    if (interval < 6 * 1000) {
   ...
   * @since 0.9.3
   */
  public void setIdleTimeout(final long timeout) throws InvalidSettingException {
    if (timeout < 0) {
   ...
   * <dl>
   * <dt>true</dt>
   * <dd>then the stack will create a TCP sub-node.</dd>
   * <dt>false</dt>
   * <dd>then the stack will not create a TCP sub-node.</dd>
   * <dt>null</dt>
   * <dd>then the stack will use the a property instead (see {@link Node} for details}.</dd>
   * </dl>
   * 
   ...
   * <dl>
   * <dt>true</dt>
   * <dd>then the stack will create a SCTP sub-node.</dd>
   * <dt>false</dt>
   * <dd>then the stack will not create a SCTP sub-node.</dd>
   * <dt>null</dt>
   * <dd>then the stack will use the a property instead (see {@link Node} for details}.</dd>
   * </dl>
   * 
   ...
   * @since 0.9.6.8
   */
  public void TCPPortRange(final PortRange port_range) throws InvalidSettingException {
   ...
   * @since 0.9.6.8
   */
  public void TCPPortRange(final int min, final int max) throws InvalidSettingException {
