...
public interface NodeValidator {
   ...
   * @param obj An object describing the transport connection. For TCP transport connections this is a socket channel.
   *        For SCTP transport connections it is a {@link RelevantSCTPAuthInfo} instance.
   */
  AuthenticationResult authenticateNode(String host_id, Object obj);
   ...
   * If the resulting common capability is empty then the peer will be disconnected with Result-Code 5010 ("no common
   * application")
   *
