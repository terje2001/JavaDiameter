...
final class ConnectionTimers {
  ...
  public ConnectionTimers(final long watchdog_timer, final long idle_close_timeout) {
  ...
  public long calcNextTimeout(final boolean ready) {
    if (!ready) {
  ...
  public timer_action calcAction(final boolean ready) {
